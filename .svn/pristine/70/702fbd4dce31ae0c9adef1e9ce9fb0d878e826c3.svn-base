...
1. The first screenshot is the login page where user will enter API key provided by tellephant.
2. This screenshot second shows the panel after login which will take information from you what you triggers you want to save and configure for your woocommerce website and panel.
3. In the third,you can select the template which can also register from tellephant and also used approved ones to configure with the provided triggers.
4. The fourth screenshot shows that the trigger what you saved and configure you can enable and disable it using a button click.
